...
# ---- Main function ----
def main( pdf_path: Path = typer.Argument(..., help="Path to the pdf file"),
            save_name: Annotated[Path, 'o'] = typer.Option(None, help="Name of the output file"),
            ):
    
    print(f"Opening {bcolors.OKCYAN} {pdf_path} {bcolors.ENDC} ...")
    pdf_document = fitz.open(pdf_path)

    print(f"{bcolors.OKCYAN} {pdf_path} {bcolors.ENDC} has {bcolors.OKGREEN} {len(pdf_document)} {bcolors.ENDC} pages")
    page_map = {}
    ...
    if save_name is None:
        save_name = pdf_path.stem + '-full.pdf'
